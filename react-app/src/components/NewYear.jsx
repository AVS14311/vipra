function NewYear({ onImageClick }) {
  ...
  return (
    <section id="new-year" className="scroll-mt-20 p-5 max-w-6xl mx-auto w-full">
      <h1 className="text-white text-[2.5rem] my-5 text-center py-2.5 break-words drop-shadow-[2px_2px_4px_rgba(0,0,0,0.5)]">
        🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰🥰
      </h1>
      {newYearImages.map((imageRow, idx) => (
        <ImageTable key={idx} images={imageRow} />
      ))}
    </section>
  )
}
